<template>
  <div>
    ...
    <div class="mb-4 flex gap-4">
      <input v-model="searchQuery" class="border p-2 w-1/3" placeholder="Search by product name..." />
    ...
    <table class="w-full border-collapse border border-gray-300">
      ...
      <tbody>
        <tr v-for="item in filteredAndSortedProducts" :key="item.id"
          ...
          <td class="border p-2">
            ...
            <span v-if="item.stock < 5" class="ml-1 text-xs text-red-500">⚠️ Low</span>
          </td>
          <td class="border p-2">
